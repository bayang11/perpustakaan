...
<table class="table table-striped table-dark">
    ...
    <tr>
        ...
        $query_kelas = mysqli_query($konek,"SELECT * FROM kelas WHERE id_kelas =$id_kelas");
        ...
        $query_jurusan= mysqli_query($konek,"SELECT * FROM jurusan WHERE id_jurusan =$id_jurusan");
